...
#import "TheBasicsAppDelegate.h"
#import "TheBasicsRoot.h"

@implementation TheBasicsAppDelegate
...
- (BOOL) application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	// Create an instance of TheBasicsRoot and set it as
	// the new root of the main display list.
	TheBasicsRoot *root = [[TheBasicsRoot alloc] init];
